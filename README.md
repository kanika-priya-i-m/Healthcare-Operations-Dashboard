...
Plotly
Project Structure
├── app.py ├── myPages/ │ ├── page1.py │ ├── page2.py │ ├── page3.py │ ├── page4.py │ ├── page5.py │ └── page6.py ├── data/ │ └── dataFinal.xlsx ├── .streamlit/ │ └── config.toml ├── Agile_document/ │ └── Niyati_agile_document.xls ├── .gitignore └── README.md
